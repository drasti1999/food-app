    ...
    <div className="my-0 py-5 bg-site bg-free-delivery">
      ...
      <div className="d-flex justify-content-center my-2 pb-3">
        <p className="text-color h5 mx-5 my-5 text-center">
          ...
          <br /> Duis euismod vestibulum nunc, id convallis dui ullamcorper ut.
          Vestibulum blandit dictum neque sit amet feugiat.
          <br />    Suspendisse eu molestie risus. Aenean eros purus, tincidunt at nibh
          ut, volutpat egestas ipsum.
          <br /> 
          Suspendisse eu molestie risus. Aenean eros purus, tincidunt at nibh
          ut, volutpat egestas ipsum.
          <br /> molestie risus. Aenean eros purus, tincidunt at nibh.<br/> molestie risus. Aenean eros purus, tincidunt at nibh.<br/>
